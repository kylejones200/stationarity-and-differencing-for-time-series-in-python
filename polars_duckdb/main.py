...
def main():
    parser = argparse.ArgumentParser(description="Stationarity & differencing — Polars + DuckDB")
    ...
    plot_differences(series_list, "date", "value", adf_results,
                     output_dir / "differencing_plot.png")
